# 在本地下载小数据，每个赛季抽取FRAC
# Download the small dataset locally and sample FRAC% for each season.
    ...
    for attempt in range(max_retries):
        try:
            ...
            if res.status_code == 200:
                ...
                print(f"尝试 {attempt+1}: 403 Forbidden，2 秒后重试...")
                time.sleep(2)
                continue
            else:
...
if __name__ == "__main__":
    W_seeds = download_local_datasets('WNCAATourneySeeds.csv', froms='github', frac=0.3)